...
/**
 * Bind minimal navigation controls to a page flip instance.
 *
 * @param {HTMLElement} viewerElement Viewer root element.
 * @param {PageFlip} pageFlip Page flip instance.
 */
export function bindViewerNavigation( viewerElement, pageFlip ) {
